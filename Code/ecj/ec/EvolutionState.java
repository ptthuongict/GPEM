...
public class EvolutionState implements Singleton
    ...
    /**PTA: number of SGX and SC for each generations*/
    public int[][] numOfSGX;
    ...
    // PTT
    public String nameProb; //ten cua bai toan hien thoi
    public int nameJob; // ten job bien thoi
    public String nameAlg; // ten cua giai thuat
    public double freeDegree;
    public RegressionData inputTrainThg; //@
    public int numFitcase;
    ...
    */
    public void setup(final EvolutionState state, final Parameter base)
        ...
        numOfSGX = new int[numGenerations][3];
        }
	...
	//PTA - for generate random trees
    public double[][] semanticTreelibTraining;
	public double[][] semanticTreelibTesting;
	public GPNode[] treelib;
	
    public int maxTreelibSize = 200;
