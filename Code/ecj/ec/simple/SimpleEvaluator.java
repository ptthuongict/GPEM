...
public class SimpleEvaluator extends Evaluator
    ...
    public static final String P_RI_RATE = "RI-rate";
    public double RIRate = 0.1;
    
    public static final String P_NUM_SAMPLES = "num-samples";
    public int numSamples = 1;
    public static final String P_TRAINING_SIZE = "training-size";
    ...
    public void setup(final EvolutionState state, final Parameter base)
        ...
        //Load RI-rate
        RIRate = state.parameters.getDoubleWithDefault(base.push(P_RI_RATE), null, -1.0);
        
        numSamples = state.parameters.getInt(base.push(P_NUM_SAMPLES), null, 0);
        trainingSize = state.parameters.getInt(base.push(P_TRAINING_SIZE), null, 1);
        } 
