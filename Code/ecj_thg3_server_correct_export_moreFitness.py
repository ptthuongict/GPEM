...
#		print fname
                ...
                # 11 cot: run, fitness (best), time (best), size average (best), size of best individual, fittest of best individual, fitness of median individual,time (median), size average (median), size of median, fittest of median:
                result[i] = result[i] + [i, l[0][1] ,l[0][2] ,l[0][3],l[0][4], l[0][5], l[NUMGENS/2][1], l[NUMGENS/2][2], l[NUMGENS/2][3],l[NUMGENS/2][4] ,l[NUMGENS/2][5]]
