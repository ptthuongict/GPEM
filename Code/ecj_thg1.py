...
#		print fname
                ...
                # run, time, size of best individual, fittest of best individual, size of median, fittest of median
                result[i] = result[i] + [i, l[0][2] ,l[0][3],l[0][4],l[NUMGENS/2][3] ,l[NUMGENS/2][4]]
